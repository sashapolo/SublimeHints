...
использовав который, автор сможет быстро оценить ваши замечания.
...
places
    ...
    выделений в редакторе, поэтому в этом поле хранится массив из диапазонов (или
    в терминах API Sublime Text *регионов*). Каждый такой регион описывается массивом
    вида ``[строка1 колонка1 строка2 колонка2]``.
